...
            {/* Search input */}
            <input
              className="w-full px-3 text-[#ffffff] bg-transparent focus:outline-none placeholder-white text-sm hover:placeholder-[#CCCCCC] transition-colors duration-500 ease-in-out"
...
                  <>
                    <button
                      className="block w-full text-center px-4 py-2 text-sm text-white hover:bg-[#343434]"
                      onClick={() => {
                        const url = seller?.slug ? `/seller/${seller.slug}` : "/seller";
