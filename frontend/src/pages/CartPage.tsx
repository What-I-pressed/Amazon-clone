    ...
    <div className="max-w-7xl mx-auto p-6 min-h-screen">
      <div className="flex gap-8">
                  ...
                  <div key={item.id} className="grid grid-cols-4 gap-4 px-6 py-4 hover:bg-gray-50">
                    ...
                    <div className="flex items-center gap-4">
                      <button
                        ...
                        disabled={loading}
                        className="text-[#989898] hover:text-[#585858] text-lg font-bold w-4 h-4 flex items-center justify-center"
                      >
                        ×
                      </button>
                    ...
                    <div className="flex items-center justify-center">
                      <div className="flex items-center border rounded-lg">
                        <button
                              ...
                              className="px-3 py-1 text-[#838383] hover:text-[#454545] disabled:opacity-50"
                            >
                              −
                            </button>           
                              <input
        ...
        <div className="w-80">
          <div className="bg-white rounded-lg shadow-sm overflow-hidden">
            {/* Header */}
            <div className="bg-[#989898] text-white px-6 py-3">
            ...
            <div className="p-6 space-y-4">
              <div className="flex justify-between items-center py-2">
                <span className="text-sm text-[#585858]">SUBTOTAL</span>
              ...
              <div className="flex justify-between items-center py-2">
                <span className="text-sm text-[#585858]">DISCOUNT</span>
                <span className="text-sm text-[#989898]">—</span>
              </div>
              ...
              <div className="pt-4">
                <a href="/checkout" className="block">
                  <button
                    ...
                    className="w-full bg-black text-white py-3 rounded-lg font-medium hover:bg-[#2a2a2a] disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Proceed To Checkout
                  </button>
                </a>
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full border border-[#dadada] text-[#454545] py-2 rounded-lg font-medium hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Clear cart
                </button>
              </div>
