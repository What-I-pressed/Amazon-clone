...
const CatalogPage: React.FC = () => {
  ...
  const products: Product[] = [
    ...
    {
      id: 2,
      name: "Wall Art Canvas 100x60 cm",
      category: "Decor",
      price: 100,
      image: "/banner.png",
    },
    ...
    {
      id: 5,
      name: "Decorative Mirror 100x70 cm",
      category: "Decor",
      price: 1050,
      image: "/banner.png",
    },
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <aside className="bg-white p-4 rounded-lg shadow-sm border space-y-6 h-fit">
            ...
            <ul className="space-y-2 text-sm text-gray-700">
              <li>
                <label className="flex items-center gap-2">
                  <input type="checkbox" className="rounded text-gray-800" /> Furniture
                </label>
              </li>
              <li>
                <label className="flex items-center gap-2">
                  <input type="checkbox" className="rounded text-gray-800" /> For Kitchen
                </label>
              </li>
              <li>
                <label className="flex items-center gap-2">
                  <input type="checkbox" className="rounded text-gray-800" /> For Backyard
                </label>
              </li>
              <li>
                <label className="flex items-center gap-2">
                  <input type="checkbox" className="rounded text-gray-800" /> Electronics
                </label>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-700">
              <li>
                <label className="flex items-center gap-2">
                  <input type="checkbox" className="rounded text-gray-800" /> $20 – $50
                </label>
              </li>
              <li>
                <label className="flex items-center gap-2">
                  <input type="checkbox" className="rounded text-gray-800" /> $50 – $200
                </label>
              </li>
              <li>
                <label className="flex items-center gap-2">
                  <input type="checkbox" className="rounded text-gray-800" /> $200 – $500
                </label>
              </li>
            </ul>
          </div>
      ...
      <footer className="bg-gray-900 text-gray-300 mt-12">
        <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h4 className="font-semibold mb-3">Subscribe To Your Newsletter</h4>
